...
<?php
    ...
    $orders = $Orders->get_recent_with_referral('1 YEAR');
        ...
        foreach($orders as $Order) {
            ...
            if (!$CustomerPromoCodes->order_has_been_issued_codes($Order->id())) {
                ...
                if ($CustomerPromoCode) {
                    ...
                    echo 'Sending purchasing customer email to: '.$Customer->customerEmail().PHP_EOL;
                }
                ...
                if ($ReferringCustomer) {
                    ...
                    if ($CustomerPromoCode) {
                        $CustomerPromoCode->send_email();
                        echo 'Sending referring customer email to: '.$ReferringCustomer->customerEmail().PHP_EOL;
                    }
