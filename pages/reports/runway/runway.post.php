<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h1 class="page-header">Runway sales</h1>
            ...
            <div class="row">
                <div class="col-xs-6">
                  <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">Runway sales</h3></div>
                    <div class="panel-body">
                        <?php
                            $results = $OrdersReports->get_monthly_sales_for_product('RUNWAY');
                ...
                <div class="col-xs-6">
                  <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">Runway upgrades</h3></div>
                    <div class="panel-body">
                        <?php
                            $results = $OrdersReports->get_monthly_sales_for_product('R2UPGRADE');
                            echo Reports::show_table(['Date', 'Full price', 'Discounted', 'GBP'], $results);
                ...
                <div class="col-xs-6">
                  <div class="panel panel-default">
                    <div class="panel-heading"><h3 class="panel-title">All Runway license and upgrade types</h3></div>
                    <div class="panel-body">
                        <?php
                            $results = $OrdersReports->get_monthly_sales_for_products(['RUNWAY', 'R2UPGRADE', 'RUNWAYDEV', 'R2DEVUPGRADE']);
                            echo Reports::show_table(['Date', 'Full price', 'Discounted', 'GBP'], $results);
                        ?>
                    </div>
                  </div>
